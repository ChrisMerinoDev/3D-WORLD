 ...
 */
// Cesium loads satellite/terrain tiles at runtime, uses WebAssembly
// (draco/basis) AND evaluates strings as code (Knockout templating uses
// `new Function`), so it requires BOTH 'unsafe-eval' and 'wasm-unsafe-eval'.
